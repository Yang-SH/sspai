...
<nav class="navbar navbar-default navbar-inverse">
	...
	<nav class="navbar navbar-default navbar-fixed-bottom navbar-inverse">
			...
			<div class="collapse navbar-collapse" id="menu">
				<form method="post" action="saveArticle.adminAction" id="artForm" >
					<div>
					<span class="font_color">专题：${allTopics}</span>
					<select style="margin-top: 15px;" name="topic_id" size="1" >
					...
					<select id="sort_id" size="1" name="sort_id" multiple="multiple" >
