        ...
        <div class="content">
			<div class="content table-responsive table-full-width">
			    <table class="table table-striped">
			        ...
			        <tbody>
			        	<c:forEach items="${articlePB.list}" var="article" >
				        	<tr>
				            	<td>${article.id}</td>
				            	...
				            	<td>
	                        		...
	                        		<div class="col-md-4">
	                        			<div class="icon-container" id="cho${article.id}">
	                        				<c:if test="${article.is_chosen==false}">
	                        					<span class="ti-medall isCho" id="${article.id}" ></span>
	                        				</c:if>
	                        				<c:if test="${article.is_chosen==true}">
	                        					精选
	                        				</c:if>
	                        			</div>
	                        		</div>
