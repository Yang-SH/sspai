...
<body style="background-color:#FAFBFC">
    	...
    	<!-- 登陆 --> 	
            <form method="post" action="login.userAction">
	            <div class="modal-body">
		            ...
		            <div class="form-group">
		            	<button id="login_btn" class="btn" type="submit">登录</button>
		            </div>
	            </div>
            </form>
	...
	<!-- 测试 -->
	<div class="bg"></div>
	<br /><br /><br /><br /><br /><br /><br /><p><a href="gomodification.userAction">修改资料</a></p>
	<br /><br /><br /><br /><br /><br /><br /><p><a href="#">闲的蛋痛</a></p>  
	<br /><br /><br /><br /><br /><br /><br /><p><a href="#">闲的蛋痛</a></p>  
	<br /><br /><br /><br /><br /><br /><br /><p><a href="#">闲的蛋痛</a></p>
	<!-- 测试 --> 
	<!-- 导航条结束 -->
